        ...
        {!isCreating ? (
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
              <div>
                <h1 className="text-4xl font-black text-zinc-900 dark:text-white tracking-tighter text-center md:text-left">Orçamentos</h1>
                <p className="text-zinc-500 dark:text-zinc-400 font-bold mt-1 uppercase text-[10px] tracking-widest text-center md:text-left">Propostas comerciais e faturamento</p>
              </div>
              <button 
            ...
            <div className="bg-white dark:bg-zinc-900/50 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 card-shadow overflow-hidden">
              <div className="p-8 border-b border-zinc-50 dark:border-zinc-800 bg-zinc-50/30 dark:bg-zinc-800/30 flex flex-col sm:flex-row justify-between items-center gap-4">
                <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">Histórico Recente</h2>
                <div className="flex items-center gap-3 px-4 py-2 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-full shadow-sm">
                  <div className="w-2 h-2 rounded-full bg-orange-500 animate-pulse"></div>
                  <span className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Monitoramento Ativo</span>
                </div>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-zinc-50/50 dark:bg-zinc-900/50 text-zinc-400 dark:text-zinc-500 text-[10px] uppercase tracking-[0.15em] font-black">
                  ...
                  <tbody className="divide-y divide-zinc-50 dark:divide-zinc-800">
                    {quotes.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).map(quote => {
                      const client = clients.find(c => c.id === quote.clientId);
                      return (
                        <tr key={quote.id} className="group hover:bg-zinc-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                          ...
                          <td className="p-6">
                            <div className="flex flex-col">
                              <span className="text-sm font-black text-zinc-900 dark:text-white group-hover:text-silver-dark transition-colors">
                                {client?.name || 'Cliente Desconhecido'}
                              </span>
                              <span className="text-[10px] text-zinc-300 dark:text-zinc-600 font-black uppercase tracking-widest">
                            ...
                            <div className="relative inline-block">
                              <select 
                                ...
                                className={`appearance-none pl-4 pr-10 py-2 rounded-full text-[10px] font-black uppercase tracking-widest border-2 cursor-pointer outline-none transition-all ${
                                  quote.status === 'APPROVED' ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 border-emerald-100 dark:border-emerald-900/30' :
                                  quote.status === 'REJECTED' ? 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border-red-100 dark:border-red-900/30' :
                          ...
                          <td className="p-6">
                            <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button 
                                ...
                                className="p-3 bg-zinc-50 dark:bg-zinc-800 text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-2xl transition-all"
                                title="Visualizar"
                              >
                              ...
                              <button 
                                ...
                                className="p-3 bg-zinc-50 dark:bg-zinc-800 text-blue-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-2xl transition-all"
                                title="Baixar PDF"
                              >
                              ...
                              <button 
                                ...
                                className="p-3 bg-zinc-50 dark:bg-zinc-800 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-2xl transition-all"
                                title="Excluir"
                              >
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
              <div className="flex items-center gap-6">
                <button 
                  ...
                  className="p-3 bg-white dark:bg-zinc-900 border-2 border-zinc-100 dark:border-zinc-800 rounded-2xl text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-all card-shadow active:scale-95"
                >
                  <ArrowLeft className="w-6 h-6" />
                </button>
                <div>
                  <h1 className="text-4xl font-black text-zinc-900 dark:text-white tracking-tighter">Nova Proposta</h1>
                  <p className="text-zinc-500 dark:text-zinc-400 font-bold mt-1 uppercase text-[10px] tracking-widest">Configure os itens e o cliente</p>
                </div>
              </div>
              <button 
                onClick={handleSave}
                className="w-full md:w-auto bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all active:scale-95 shadow-xl shadow-zinc-200 dark:shadow-none flex items-center justify-center gap-3"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="lg:col-span-1 space-y-8">
                <div className="bg-white dark:bg-zinc-900/50 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 card-shadow p-8">
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 dark:text-zinc-500 mb-8">Informações Base</h3>
                  
                  <div className="space-y-6">
                    <div>
                      <label className="block text-[10px] font-black uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-2">Cliente Destinatário</label>
                      <select 
                        value={clientId}
                    ...
                    <div>
                      <label className="block text-[10px] font-black uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-2">Importação Rápida (CSV)</label>
                      <input 
                        type="file" 
                        accept=".csv" 
                        ref={fileInputRef}
                      ...
                      <label 
                        htmlFor="csv-upload"
                        className="w-full flex flex-col items-center justify-center gap-4 border-2 border-dashed border-zinc-100 dark:border-zinc-800 rounded-[2rem] p-10 text-zinc-300 dark:text-zinc-700 hover:border-zinc-900 dark:hover:border-white hover:text-zinc-900 dark:hover:text-white cursor-pointer transition-all group bg-zinc-50/50 dark:bg-zinc-800/30"
                      >
                ...
                <div className="bg-zinc-900 dark:bg-zinc-900 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-zinc-200 dark:shadow-none border border-white/5 relative overflow-hidden group">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white dark:bg-zinc-900/50 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 card-shadow overflow-hidden">
                  <div className="p-8 border-b border-zinc-50 dark:border-zinc-800 bg-zinc-50/30 dark:bg-zinc-800/30 flex flex-col sm:flex-row justify-between items-center gap-6">
                    <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">Itens da Proposta</h2>
                    <div className="flex gap-3 w-full sm:w-auto">
                      <select 
                        ...
                        className="flex-1 bg-white dark:bg-zinc-900 border-2 border-zinc-100 dark:border-zinc-800 rounded-2xl px-6 py-3 text-[10px] font-black uppercase tracking-widest focus:border-zinc-900 dark:focus:border-white outline-none transition-all shadow-sm text-zinc-900 dark:text-white"
                      >
                      ...
                      <button 
                        onClick={addItem}
                        className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 p-4 rounded-2xl hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all active:scale-95 shadow-lg shadow-zinc-200 dark:shadow-none"
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="bg-zinc-50/50 dark:bg-zinc-900/50 text-zinc-400 dark:text-zinc-500 text-[10px] uppercase tracking-wider font-black">
                      ...
                      <tbody className="divide-y divide-zinc-50 dark:divide-zinc-800">
                        {items.map((item) => (
                          <tr key={item.id} className="group hover:bg-zinc-50/30 dark:hover:bg-zinc-800/30 transition-colors">
                            <td className="p-4">
                              <input 
                                type="text" 
                                value={item.description}
                                onChange={(e) => updateItem(item.id, 'description', e.target.value)}
                                className="w-full bg-transparent border-2 border-transparent rounded-xl px-4 py-3 text-sm font-black text-zinc-900 dark:text-white focus:bg-white dark:focus:bg-zinc-900 focus:border-zinc-900 dark:focus:border-white outline-none transition-all"
                            ...
                            <td className="p-4">
                              <input 
                                ...
                                className="w-full bg-transparent border-2 border-transparent rounded-xl px-4 py-3 text-sm font-mono font-bold text-center text-zinc-500 dark:text-zinc-400 focus:bg-white dark:focus:bg-zinc-900 focus:border-zinc-900 dark:focus:border-white outline-none transition-all"
                                min="1"
                              />
                            </td>
                            <td className="p-4">
                              <input 
                                ...
                                className="w-full bg-transparent border-2 border-transparent rounded-xl px-4 py-3 text-sm font-mono font-bold text-right text-zinc-500 dark:text-zinc-400 focus:bg-white dark:focus:bg-zinc-900 focus:border-zinc-900 dark:focus:border-white outline-none transition-all"
                                min="0"
                                step="0.01"
                              />
                            </td>
                            ...
                            <td className="p-4 text-center">
                              <button 
                                ...
                                className="p-3 text-zinc-300 dark:text-zinc-700 hover:text-red-600 transition-colors rounded-2xl hover:bg-red-50 dark:hover:bg-red-900/20"
                              >
                                <Trash2 className="w-5 h-5" />
                              </button>
                            </td>
        ...
        {viewingQuote && (
          <div className="space-y-8">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 dark:text-zinc-500 mb-1">Cliente</p>
              ...
              <div className="text-right">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 dark:text-zinc-500 mb-1">Valor Total</p>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800">
              <table className="w-full text-left">
                <thead>
                  <tr className="text-[10px] font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-500 border-b border-zinc-100 dark:border-zinc-800">
                ...
                <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
                  {viewingQuote.items.map((item) => (
                    <tr key={item.id}>
                      <td className="p-4 text-sm font-bold text-zinc-900 dark:text-zinc-100">{item.description}</td>
                      <td className="p-4 text-sm text-center text-zinc-600 dark:text-zinc-400 font-mono">{item.quantity}</td>
                      <td className="p-4 text-sm text-right text-zinc-600 dark:text-zinc-400 font-mono">
                        {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(item.unitPrice)}
                      </td>
                      <td className="p-4 text-sm text-right font-black text-zinc-900 dark:text-zinc-100 font-mono">
                        {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(item.total)}
                      </td>
                    </tr>
                  ))}
                  ...
                  {companyLogo ? (
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-3xl font-light tracking-widest text-zinc-400 leading-none">TEC</span>
                      </div>
                    </div>
                  )}
              ...
              <div className="mb-20">
                <div className="grid grid-cols-12 gap-12">
                  <div className="col-span-8">
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-4">Cliente / Destinatário</p>
                  ...
                  <div className="flex justify-between items-start mb-20">
                    ...
                    <div className="text-right space-y-4">
                      ...
                      <div className="space-y-1 pt-4 border-t border-zinc-100">
                        <p className="text-[12px] font-black uppercase tracking-[0.6em] text-zinc-400">Investimento Total</p>
